...
<html lang="pt-BR">
	...
	<body>
		<div class="container">
			...
			<p>O mercado Pão de Açucar não faz lista de presente. Então, a lista abaixo foi feita para gerenciar a quantidade de produtos ainda disponível.</p>
			<p>Antes de reservar o produto, primeiro certifique que tenha o produto no mercado, pois pode ser que tenha acabado.</p>
